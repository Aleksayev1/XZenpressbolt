...
export const acupressurePoints: AcupressurePoint[] = [
...

  {
    ...
    description: 'Ponto para aliviar rinite alérgica, desobstruir vias nasais, reduzir sinusite e melhorar respiração nasal. Localizado na testa no meio dos pontos verticais, onde tem uma seta. Massagear suavemente com movimentos circulares por 2-3 minutos.',
