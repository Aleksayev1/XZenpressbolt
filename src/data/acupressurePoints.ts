...
export const acupressurePoints: AcupressurePoint[] = [
  // ===== PONTOS GRATUITOS - MTC (Medicina Tradicional Chinesa) =====
  {
    ...
    position: { x: 50, y: 25 },
    image: '/ponto-da-acupuntura-que-tira-ex-hn-yintang-EX%20HN3.jpg',
...

  {
    ...
    position: { x: 50, y: 90 },
    image: '/R1%20Acalma%20a%20mente,%20Vertigem,%20Tontura%20Agita%C3%A7%C3%A3o.jpg',
...

  {
    ...
    position: { x: 50, y: 30 },
    image: '/Ponto%20b%C3%A1sico%20A%20dor%20de%20cabe%C3%A7a%20e%20enxaqueca%20copy%20copy%20copy.jpg',
...

  {
    ...
    position: { x: 20, y: 70 },
    image: '/C%207%20Shenmen%20Acalma%20a%20mente%20Estresse.jpg',
...

  {
    ...
    position: { x: 50, y: 75 },
    image: '/PC8%20Laogong%20Medo%20ansiedade%20boca%20seca.jpg',
...

  {
    ...
    position: { x: 50, y: 40 },
    image: '/Voz%20rouca,%20tosse%20Ren%2022%20Tiantu.jpg',
...

  {
    ...
    position: { x: 50, y: 35 },
    image: '/Ponto%20Nariz%20Alergia,%20rinite,%20sinusite,%20obstru%C3%A7%C3%A3o.jpg',
...

  {
    ...
    position: { x: 50, y: 20 },
    image: '/Pontos%20Cerebro%20e%20cerebelo%20Sono,%20Tonturas,%20Depress%C3%A3o.jpg',
  ...
  // ===== PONTOS PREMIUM - SEPTICEMIA =====
  {
    ...
    position: { x: 25, y: 45 },
    image: '/IG11%20febre%20sede%20herpes%20prurido.jpg',
...

  {
    ...
    position: { x: 45, y: 80 },
    image: '/st%2036%20Est%C3%B4mago%20imunidade%20a.jpg',
  ...
  // ===== PONTOS PREMIUM - ATM (Articulação Temporomandibular) =====
  {
    ...
    position: { x: 75, y: 30 },
    image: '/TA%2021%20Ermen%20Portal%20da%20Orelha%20ATM.jpg',
...

  {
    ...
    position: { x: 70, y: 40 },
    image: '/ATM%20Premiun/Ponto%20A.jpg',
...

  {
    ...
    position: { x: 85, y: 35 },
    image: '/ATM%20Premiun/Marca%C3%A7%C3%A3o%203%20pontos%20ATM%20cranio.jpg',
...

  {
    ...
    position: { x: 50, y: 25 },
    image: '/Ponto%20b%C3%A1sico%20A%20dor%20de%20cabe%C3%A7a%20e%20enxaqueca.jpg',
...

  {
    ...
    position: { x: 85, y: 35 },
    image: '/ANmian%20sono%20tranquilo%20pesadelos.jpg',
