...
export const acupressurePoints: AcupressurePoint[] = [
  ...
  },
  {
    ...
    description: 'No topo da cabeça, abordagem energética MTC para combater fadiga mental e melhorar clareza através da estimulação do ponto de convergência dos meridianos.',
    descriptionEn: 'At the top of the head, TCM energetic approach to combat mental fatigue and improve clarity through stimulation of meridian convergence point.',
    descriptionEs: 'En la parte superior de la cabeza, enfoque energético MTC para combatir fatiga mental y mejorar claridad a través de estimulación del punto de convergencia de meridianos.',
    descriptionFr: 'Au sommet de la tête, approche énergétique MTC pour combattre fatigue mentale et améliorer clarté par stimulation du point de convergence des méridiens.',
    position: { x: 25, y: 75 },
    image: '/images/points/mtc-vertex.jpg',
    imageAlt: 'Localização do ponto do vértice craniano com abordagem energética MTC',
    ...
    isPremium: false,
    category: 'mtc', 
    instructions: 'Pressione suavemente o topo da cabeça com a palma da mão por 2-3 minutos, focando no equilíbrio energético dos meridianos.',
    duration: 120,
    pressure: 'leve'
  },
  ...
  },
  {
    ...
    position: { x: 50, y: 12 },
    image: '/images/points/cranio-hegu.jpg',
    imageAlt: 'Localização do ponto Hegu com técnica craniana adaptada entre polegar e indicador',
