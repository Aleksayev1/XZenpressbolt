...
export const acupressurePoints: AcupressurePoint[] = [
...

  {
    ...
    position: { x: 50, y: 15 },
    image: 'https://imgur.com/a/fqoGVk1',
...

  {
    ...
    position: { x: 50, y: 90 },
    image: 'https://imgur.com/a/fqoGVk1jpg',
...

  {
    ...
    position: { x: 50, y: 30 },
    image: 'https://imgur.com/a/tFbBUUr',
...

  {
    ...
    position: { x: 20, y: 70 },
    image: 'https://imgur.com/a/hh2h5sw',
  ...
  // ===== PONTOS PREMIUM - SEPTICEMIA =====
  {
    ...
    position: { x: 25, y: 45 },
    image: 'https://imgur.com/a/btzXnY2',
...

  {
    ...
    position: { x: 30, y: 65 },
    image: 'https://imgur.com/a/vgnMaVA',
  ...
  {
    id: 'atm-cranio 3 em 1',
    name: 'Ycranio 3 em 1 - Protocolo Cranio',
    nameEn: 'Ycranio 3 em 1 - Cranio Protocol',
    nameEs: 'Ycranio 3 em 1 - Protocolo craneo',
    nameFr: 'Ycranio 3 em 1 - Protocole Crâniot',
    description: 'Ponto para regular ATM, reduzir zumbido no ouvido, aliviar tensão mandibular e melhorar audição. Localizado topo da cabeça  (veja as marcações dos 3 pontos ATM no crânio na imagem). Massagear suavemente com movimentos circulares por 3-4 minutos.',
    descriptionEn: 'Point to regulate TMJ, reduce ear ringing, relieve jaw tension and improve hearing. Located top of head. Massage gently with circular movements for 3-4 minutes.',
    descriptionEs: 'Punto para regular ATM, reducir zumbido en oído, aliviar tensión mandibular y mejorar audición. parte superior de la cabeza. Masajear suavemente con movimientos circulares por 3-4 minutos.',
    descriptionFr: 'Point pour réguler ATM, réduire acouphènes, soulager tension mandibulaire et améliorer audition. Situé sommet de la tête. Masser doucement avec mouvements circulaires pendant 3-4 minutes.',
    position: { x: 85, y: 35 },
